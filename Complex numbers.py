...
They are used by interpreters and are generally used in the implementation of overloaded operators or
...
class Complex(object):
    ...
    def __truediv__(self, no):
        common = Complex(*[no.real, -1 * no.imaginary])
        numerator = self * common
        denominator = no * common
